...
import { getAllProductDetail } from "../../services/products.service";
...
const ProductDetail = async ({ params }: TPageProps) => {
  ...
  return (
    <main className="container mx-auto py-40 flex gap-12">
      <div className="bg-primary-light aspect-square min-w-140 flex justicy-center items-center">
        <Image
      ...
      <div className="w-full py-7">
        ...
        <p className="w-4/5 leading-loose mb-8">{product.description}</p>
